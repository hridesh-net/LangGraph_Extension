...
7.	Submit a pull request: Go to the original repository and submit a pull request with a description of your changes.
...
--- | --- | --- 
Hridesh Sharma(Author) | [@hridesh-net](https://github.com/hridesh-net) | Initial project setup and development 
Naman Kaley | [@naman-cell](https://github.com/Naman-cell) | Feature Integration, Bug fixes
